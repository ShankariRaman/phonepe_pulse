...
mycursor.execute(
    "create table agg_transer (State varchar(100), Year int, Quarter int, Transaction_type varchar(100), Transaction_count int, Transaction_amount double)")
...
mycursor.execute(
    "create table agg_users (State varchar(100), Year int, Quarter int, Brands varchar(100), Count int, Percentage double)")
...
mycursor.execute(
    "create table map_useres (State varchar(100), Year int, Quarter int, Registered_user int,District varchar(100), App_opens int)")
...
mycursor.execute(
    "create table top_trans2 (State varchar(100), Year int, Quarter int,  Pincode varchar(100), Transaction_count int, Transaction_amount double)")
...
mycursor.execute(
    "create table top_user1 (State varchar(100), Year int, Quarter int, Districts varchar(100) , Registered_users int)")
